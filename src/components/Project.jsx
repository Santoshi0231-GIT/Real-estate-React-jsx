...
useEffect(()=>{
  ...
  return (
    <motion.div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Project'
    ...
    >
        ...
        <p className='text-center text-gray-600 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore 
            Our Portfolio
        </p>
        {/* slider buttons */}
...
<img src={project.image} alt={project.title} className='w-full '  /><div className='absolute left-0 right-0 bottom-5 flex justify-center bg-white py-2 shadow-md  w-3/4'>
<div className='absolute  bottom-5  inline-block bg-white w-3/4 px-4 shadow-md '>
